...
Este é um documento para orientação em como contribuir para o repositório de documentação do Aplicativo Multilind. Antes de começar a contribuir veja as [issues já abertas](https://github.com/fga-eps-mds/2021.1-Multilind-Docs/issues), e a nossa [documentação já existente](https://fga-eps-mds.github.io/2021.1-Multilind-Docs/#/).
...
* [Consertar erros](#consertou-um-bug)
...
## Comece a contribuir
Quer começar a contribuir para o app? O processo em geral é bem simples:
...
- Seu pull request será revisado por pelo menos dois mantenedores, que podem levantar questões para você sobre eventuais mudanças necessárias ou questões.
...
Antes de reportar o Bug, veja as [issues com a tag `bug`](https://github.com/fga-eps-mds/2021.1-Multilind-Docs/labels/bug) e verifique se o erro identificado já não possui uma issue criada.
...
Descrição do que pode ser feito para resolver o bug. (sugestões e outros levantamentos)
...
### Assignees
A *issue* deve ser atribuída a pelo menos uma pessoa colaboradora do projeto. (se possível colaboradores que tenham participado na construção/atualização dos arquivos inclusos no bug)
...
**Para cada mensagem de commit é interessante que seja seguido o padrão utilizado pelo projeto. A mensagem padrão consiste em uma descrição breve do que foi realizado e, se necessário, os arquivos participantes da modificação. Além disso o comentário deve estar em inglês e no infinitivo.**
