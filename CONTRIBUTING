...
Este é um documento para orientação em como contribuir para o repositório de documentação do Aplicativo de Línguas Indígenas. Antes de começar a contribuir veja as [issues já abertas](https://github.com/fga-eps-mds/2021.1-Linguas-Indigenas-Docs/issues), e a nossa [documentação já existente](https://fga-eps-mds.github.io/2021.1-Linguas-Indigenas-Docs/#/).
...
Antes de reportar o Bug, veja as [issues com a tag `bug`](https://github.com/fga-eps-mds/2021.1-Linguas-Indigenas-Docs/labels/bug) e verifique se o erro identificado já não possui uma issue criada.
